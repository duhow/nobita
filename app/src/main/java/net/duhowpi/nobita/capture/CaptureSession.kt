...
data class CaptureSession(val startedAt: Long, val target: String, val previousMode: String = "disabled", val bluetoothInitiallyEnabled: Boolean = true) {
    fun save(context: Context) = context.getSharedPreferences(PREFERENCES, Context.MODE_PRIVATE).edit()
        ...
        .putBoolean(KEY_BLUETOOTH, bluetoothInitiallyEnabled).apply()
