...
class CaptureForegroundService : Service() {
            ...
            override fun onServiceConnected(name: ComponentName?, binder: IBinder?) {
                Thread {
                    ...
                    try {
                        ...
                        progress.start()
                        val path = try {
                            boundService.stopAndExport(session.captureId)
                        } finally {
    ...
    companion object { private const val CHANNEL = "capture"; private const val ID = 42; private const val USER_SERVICE_VERSION = 7; const val ACTION_STOP = "net.duhowpi.nobita.STOP"; const val ACTION_EXPORTING = "net.duhowpi.nobita.EXPORTING" }
}
